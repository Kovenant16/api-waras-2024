...
        // const connectedSock = await startSock(); // Línea comentada
        // if (connectedSock) { // Línea comentada
        //     console.log('WhatsApp conectado y listo.'); // Línea comentada
        // } else { // Línea comentada
        //     console.error('Error al iniciar la conexión de WhatsApp.'); // Línea comentada
        // } // Línea comentada
